        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="https://youtube.com/@fondationalphaperla?si=4PRNSY_c6-LxqA4O"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-3 bg-destructive text-white rounded-lg font-semibold hover:bg-destructive/90 transition-colors w-full sm:w-auto"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-3 bg-[#1877F2] text-white rounded-lg font-semibold hover:bg-[#1877F2]/90 transition-colors w-full sm:w-auto"
              >
                <svg
                  className="w-6 h-6 mr-2"
                  fill="currentColor"
